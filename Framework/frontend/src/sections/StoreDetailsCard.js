...
const renderFormControl = (label, type, placeholder, value, setter) => {
  return (
    <>
        ...
        <Card.Body>
          <Card.Title>
            <h2>
              ...
              {isEditMode ? 'Edit Store: ' + storeID : 'New Store Details'}
            </h2>
          </Card.Title>
          <Card.Text></Card.Text>
          ...
          {renderFormControl('Username', 'text', 'Ex. Maria', name, setName)}
          {renderFormControl(
            'Email',
            'email',
            'Ex. maria@example.com',
            email,
            setEmail
          )}
        </Card.Body>
